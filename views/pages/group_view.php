...
<hr>
<h2>Painel do Grupo: <?php echo htmlspecialchars($grupo['nome_grupo']); ?></h2>
...
<?php if ($is_empty_state): ?>
    ...
    <div class="cards-wrapper" style="display: flex; gap: 20px; margin-top: 20px;">
        ...
        <?php if ($grupo['id_admin'] == $_SESSION['user_id']): ?>
            <div class="card-options">
                ...
                <h4>Adicionar Membro por E-mail (HU006)</h4>
        ...
        <div class="card"
            style="flex: 1; padding: 20px; background: #222; border: 1px solid #444; border-radius: 10px; text-align: center; opacity: 0.5;">
            <i class="fa fa-shopping-cart" style="font-size: 40px;"></i>
            <h3 style="margin-top: 10px;">Registrar a primeira conta</h3>
            <p>Assim que tiver membros, adicione uma despesa para começar a divisão.</p>

            <button class="btn" style="background-color: #555; cursor: not-allowed;" disabled>
                Adicionar despesa
            </button>
        </div>
    </div>
